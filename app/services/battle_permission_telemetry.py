...
class TpoDailyReportBuilder:
    def __init__(
        ...
        *,
        ...
        self.battle_telemetry_path = (
            battle_telemetry_path
            or runtime_dir / "telemetry" / "battle_permission_events.ndjson"
        )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--battle-telemetry-path",
        default=None,
        help="Path to battle_permission_events.ndjson.",
    )
    parser.add_argument(
        "--output-dir",
        default=None,
